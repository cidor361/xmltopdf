...
$string['auth_scosclientid'] = 'Your client ID/Secret
<br/>Homepage URL: {$a->siteurl}
<br/>Authorization callback URL: {$a->callbackurl}';
$string['auth_scosclientid_key'] = 'SCOS client ID';
$string['auth_scosclientsecret'] = '';
$string['auth_scosclientsecret_key'] = 'SCOS client secret';
