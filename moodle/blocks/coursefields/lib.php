...
function get_form_data($Object, $formdata)
{
    ...
    if (!empty($formdata->competences["text"])) {
        $Object->competences = strip_tags_competences($formdata->competences["text"]);
    };
