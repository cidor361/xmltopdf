...
//        $mform->addElement('text', 'requirements', get_string('requirements', 'block_coursefields'));
        ...
        $mform->addElement('editor', 'direction', get_string('direction', 'block_coursefields'), null, $attributes);
        $attributes = array('size' => '50', 'maxlength' => '100');
        ...
        $attributes = array('trusttext'=>true, 'subdirs'=>true, 'maxfiles'=>$maxfiles, 'maxbytes'=>$maxbytes, 'context'=>$context);
        $mform->addElement('editor', 'results', get_string('results', 'block_coursefields'), null, $attributes);
        $attributes = array('size' => '50', 'maxlength' => '100');
